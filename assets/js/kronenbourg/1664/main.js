...
var StickyNavbar = {
    ...
    autoHideScroll: function() {
        ...
        if ((currentScrollTop > self.lastScrollTop && !self.goingDown) || (currentScrollTop < self.lastScrollTop && self.goingDown)) {
            self.scrollTop = currentScrollTop;
            self.goingDown = !self.goingDown;
            self.range = 0;
        } else {
            self.range = self.goingDown ? currentScrollTop - self.scrollTop : self.scrollTop - currentScrollTop;
        }
...
var AgeGate = {
    $modalAgeGate: [],
    countries: { 'DZ': 18, 'AO': 18, 'BI': 18, 'CM': 21, 'CV': 18, 'CF': 18, 'KM': 0, 'CD': 18, 'EG': 21, 'GQ': 0, 'ER': 18, 'ET': 18, 'GA': 18, 'GM': 18, 'GH': 18, 'GW': 0, 'KE': 18, 'LS': 18, 'LY': Infinity, 'MW': 18, 'MU': 18, 'MA': 16, 'MZ': 18, 'NA': 18, 'NE': 18, 'NG': 18, 'CG': 18, 'RW': 18, 'SN': 0, 'SC': 18, 'SO': Infinity, 'ZA': 18, 'SS': 18, 'SD': Infinity, 'SZ': 18, 'TZ': 18, 'TG': 18, 'TN': 18, 'UG': 18, 'ZM': 18, 'ZW': 18, 'AG': 16, 'AR': 18, 'BS': 18, 'BZ': 18, 'BM': 18, 'BO': 18, 'BR': 18, 'VG': 16, 'CA': 19, 'KY': 18, 'CL': 18, 'CO': 18, 'CR': 18, 'CU': 18, 'DO': 18, 'EC': 18, 'SV': 18, 'FK': 18, 'GT': 18, 'GY': 18, 'HT': 16, 'HN': 18, 'JM': 16, 'MX': 18, 'NI': 18, 'PA': 18, 'PY': 20, 'PE': 18, 'PR': 18, 'TT': 18, 'US': 21, 'VI': 18, 'UY': 18, 'VE': 18, 'AF': Infinity, 'BD': Infinity, 'BN': Infinity, 'KH': 0, 'CN': 18, 'HK': 18, 'IN': 18, 'ID': 21, 'IR': 18, 'JQ': 18, 'IL': 18, 'JP': 20, 'JO': 18, 'KZ': 21, 'KW': Infinity, 'KG': 18, 'LB': 18, 'MO': 18, 'MY': 18, 'MV': 18, 'MN': 18, 'NP': 18, 'KP': 18, 'OM': 21, 'PK': 21, 'PS': 16, 'PH': 18, 'QA': 21, 'SA': Infinity, 'SG': 18, 'KR': 19, 'LK': 21, 'SY': 18, 'TW': 18, 'TJ': 21, 'TH': 21, 'TM': 18, 'AE': 21, 'VN': 0, 'YE': Infinity, 'AL': 18, 'AM': 18, 'AT': 18, 'AZ': 18, 'BY': 18, 'BE': 18, 'BA': 18, 'BG': 18, 'HR': 18, 'CY': 17, 'CZ': 18, 'DK': 18, 'EE': 18, 'FI': 18, 'FR': 18, 'GE': 16, 'DE': 18, 'GI': 18, 'GR': 18, 'HU': 18, 'IS': 20, 'IE': 18, 'IT': 18, 'XK': 18, 'LV': 18, 'LI': 18, 'LT': 18, 'LU': 16, 'MK': 18, 'MT': 17, 'MD': 16, 'ME': 18, 'NL': 18, 'NO': 20, 'PL': 18, 'PT': 18, 'RO': 18, 'RU': 18, 'RS': 18, 'SK': 18, 'SI': 18, 'ES': 18, 'SE': 18, 'CH': 18, 'TR': 18, 'UA': 18, 'GB': 18, 'AS': 21, 'AU': 18, 'FJ': 18, 'GU': 21, 'FM': 21, 'NZ': 18, 'MP': 21, 'PW': 21, 'PG': 18, 'WS': 18, 'SB': 21, 'TK': 18, 'TO': 21, 'VU': 18 },
    ...
    init: function() {
        ...
        document.getElementById('ageGateEnterSiteBtn').addEventListener('click', self.checkAge.bind(self));
    },
